...
const Navbar = () => {
  const AccountBalance = () => {
    ...
    return (
      <div
        className={
          data?.formatted == 0 || 1 ? `AccountBalance_nav` : `AccountBalance`
        }
      >
        <section className=" container-xxl">
          {data?.formatted == 0 || 1 ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="low_polygon"
            >
              {" "}
              Running low on funds? – you can get free testnet Polygon to help
              you get started!&quot;{" "}
              <Image
          ...
          <nav className="fixed top-0 z-50 w-full  border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center justify-start main_nav">
                  <button
