      ...
      <div className="h-full px-3 pb-4 overflow-y-auto bg-dark dark:bg-gray-800 sidebar">
        <ul className="space-y-2">
          <li>
            <a
              href="/"
              className="nav-link  flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <svg
                aria-hidden="true"
          ...
          <li>
            ...
            >
              <svg
                aria-hidden="true"
                className="nav-link flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
